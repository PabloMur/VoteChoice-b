...
export const GoogleButton = () => {
    ...
    return (
        <button
            ...
            className="text-primaryPurple font-dmsans font-medium border-primaryPurple border rounded-full w-full py-1 flex items-center justify-center gap-4 md:gap-0.5 xl:gap-2 "
        >
            <picture>
                <img
