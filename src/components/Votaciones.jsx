    ...
    return (
        <>
            ...
            <div className="w-full xl:w-3/5 mt-6 font-dmsans mx-4 xl:mx-0 sm:py-5 test:flex test:flex-col test:items-center test:w-2/3 xl:block xl:ml-40">
                <h1 className="ml-6 mb-4 text-4xl font-bold text-center xl:text-start">
                    Votaciones
                </h1>
                {!rooms.length ? (
                    <div className="flex flex-col items-center justify-center bg-secondaryGray dark:bg-darkNav pt-6 test:w-4/5 shadow rounded-4xl h-90 sm:h-85">
                        <p>Aún no has participado en una votación.</p>
                    </div>
                ) : (
                    <div className="flex flex-col bg-secondaryGray dark:bg-darkNav pt-6 test:w-4/5 shadow rounded-4xl pb-20 sm:pb-0">
                        ...
                        <div className="flex gap-4 pl-6 py-5">
                            <div className="flex justify-center items-center rounded-full bg-slate-300 gap-2 w-24 h-6 cursor-pointer">
                                ...
                                <button className="text-xs text-semibold">
                                    Activas
                                </button>
                            </div>
                            <div className="flex justify-center items-center rounded-full bg-slate-300 gap-2 w-24 h-6 cursor-pointer">
                        ...
                        <div className="flex flex-col gap-4 px-8 pb-10 h-44 py-2 overflow-y-auto mb-2">
                            {filteredRooms.map((sala, index) => (
                                ...
                                >
                                    ...
                                    <ModalGeneral
                                        state={
                                            modalResultsStates[sala.roomId] ||
                                            false
